...
class TestGetLastRelationModified:
    ...
    def set_env_vars(self, project):
        os.environ["DBT_GET_LAST_RELATION_TEST_SCHEMA"] = project.database
        yield
    ...
    def test_get_last_relation_modified(self, project, set_env_vars, custom_schema):
        project.run_sql(
            f"create table {custom_schema}.test_table (id integer auto_increment primary key, name varchar(100) not null);"
        )
